...
import test from './assets/테스트.xlsx';
    ...
    const columnDef = [
        {
            ...
            cellRendererFramework: (grid) => {
                ...
                let value = '';
                if (
                    grid.node.allChildrenCount &&
                    grid.node.allChildrenCount > 0
                ) {
